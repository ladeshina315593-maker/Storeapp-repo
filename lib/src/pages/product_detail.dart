...
class _ProductDetailPageState extends State<ProductDetailPage>
  ...
  Future<void> _toggleFavourite() async {
    ...
    try {
      ...
      final favoriteData =
        ...
        // Actual resolved image.
        'imageUrl': selectedImage,
        'image': selectedImage,

        // Extra image field for recovery.
        'images': [
          selectedImage,
        ],
      ...
      // Remove null values so Firestore doesn't receive
      ...
      debugPrint(
        'PikkX Favourite ERROR: $e',
      );
      debugPrint(
        'Favourite stackTrace: $stackTrace',
      );
    }
  }
  ...
  Future<void> _toggleFollow() async {
    ...
    try {
      ...
      debugPrint(
        'PikkX Follow ERROR: $e',
      );
      debugPrint(
        'Follow stackTrace: $stackTrace',
      );
    } finally {
      if (mounted) {
        setState(() {
    ...
    return Column(
      ...
      children: [
        ...
        _reviewCard(
          ...
          rating: 4,
          text:
              'Nice quality and the color looks just like the product.',
        ),
      ],
    );
  }
